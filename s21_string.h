...
s21_size_t s21_strlen(const char *str) __attribute__((nonnull(1)));
char *s21_strpbrk(const char *str1, const char *str2)
    __attribute__((nonnull(1, 2)));
char *s21_strrchr(const char *str, int c) __attribute__((nonnull(1)));
...
void itostr(char *ouput, int num);
...
void X_to_str(char *output, unsigned long long num, s21_size_t size,
              char length);
void o_to_str(char *output, unsigned long long num, s21_size_t size,
              char length);

//  длина L
void f_to_str(char *output, long double num, s21_size_t size, char length);
void e_to_str(char *output, long double num, s21_size_t size, char length);
void E_to_str(char *output, long double num, s21_size_t size, char length);
void g_to_str(char *output, long double num, s21_size_t size, char length,
              int *accuracy);
void G_to_str(char *output, long double num, s21_size_t size, char length,
              int *accuracy);
...
const char *check_inf_nan(const char *str, long double *result, int flag_minus);
